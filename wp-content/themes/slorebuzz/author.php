			...
			<div id="content" role="main">
				...
				<div class="profile-contact">
					<p style="margin-bottom:7px;">
						...
						<a href="<?=$expanded_profile['contact-email-address']; ?>" style="text-decoration:none;margin-right:7px;"><img src="/wp-content/themes/slorebuzz/images/email.png" style="vertical-align:middle;"/> Email</a>
					</p>
