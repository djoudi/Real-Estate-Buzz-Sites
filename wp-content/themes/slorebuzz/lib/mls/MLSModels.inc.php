...
class ResidentialModel extends MySQLRepository {
   ...
   /**
    * Convert a "natural language" search to explicit paramters.
    *
    * Nothing fancy here - just a bunch of regexes to catch the most common
    * cases.
    *
    * @param string   A string a person might type looking for a listing.
    *               ex. "2BR 3 bath 1500 sqFt $200k-$350k in 93401 on Johnson"
    * @return array   An array of name/value pairs suitable for passing to
    *                 the Search() function.
    * @see Search()
    **/
