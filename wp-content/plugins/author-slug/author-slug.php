<?php 
/*
Plugin Name: Author slug
Plugin URI: http://www.microkid.net/wordpress/author-slug/
Description: Change the author slug in the permalink for author pages.
Author: Microkid
Version: 2.0
...
function AS_add_options_page() {
	add_options_page("Author slug", __('Author slug', 'author-slug'), "manage_options", __FILE__, "AS_options_page");
}
